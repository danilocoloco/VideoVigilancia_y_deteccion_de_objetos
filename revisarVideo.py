...
def camara():
    ...
    logging.basicConfig(level=logging.DEBUG,
                        ...
                        filename=("GRABACIONES/"+"Indicencias_videoReproducido_enHora_"+time.strftime("%d_%m_%y_%H%M%S")+'.log'),
                        filemode='w', )
    logging.debug('REGISTRO DE INCIDENCIAS. Se ha detectado movimiento')
    ...
    with detection_graph.as_default():
        file = tkinter.filedialog.askopenfilename(defaultextension="*.avi", title="Control: diropenbox",
                                                  initialdir="/GRABACIONES/", parent=None)
